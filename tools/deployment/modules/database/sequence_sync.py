...
class SequenceSync:
    ...
    def __init__(self, db_service, engine, db_type: str, metadata_cache: TableMetadataCache, logger, formatter):
        """
        Инициализация синхронизации sequences
        """
                ...
                for table_name, _table_class in all_tables.items():
                    ...
                    for field_info in autoincrement_fields:
                        ...
                        if max_id > 0:
                            ...
                            self.formatter.print_success(f"Синхронизирован sequence {sequence_name} с ID {max_id}")
            
            return True
            
        except Exception as e:
            self.formatter.print_error(f"Ошибка синхронизации sequence: {e}")
            return False
