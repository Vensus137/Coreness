...
- [🚀 Быстрый старт](#-быстрый-старт)
  ...
  - [Создание первого сценария](#создание-первого-сценария)
  - [Синхронизация изменений](#синхронизация-изменений)
- [💳 Продвинутые примеры](#-продвинутые-примеры)
  - [Работа с оплатами (Invoices)](#работа-с-оплатами-invoices)
    - [Обзор механизма оплаты](#обзор-механизма-оплаты)
    - [Создание инвойса](#создание-инвойса)
    - [Обработка pre_checkout_query](#обработка-pre_checkout_query)
    - [Обработка payment_successful](#обработка-payment_successful)
    - [Полный пример: Flow оплаты](#полный-пример-flow-оплаты)
    - [Рекомендации и best practices](#рекомендации-и-best-practices)
  - [Работа с RAG хранилищем](#работа-с-rag-хранилищем)
    - [Обзор RAG системы](#обзор-rag-системы)
    - [Сохранение данных в векторное хранилище](#сохранение-данных-в-векторное-хранилище)
    - [Семантический поиск](#семантический-поиск)
    - [Получение последних чанков](#получение-последних-чанков)
    - [Использование RAG в AI completion](#использование-rag-в-ai-completion)
    - [Полный пример: RAG flow](#полный-пример-rag-flow)
...
Создайте папку в `tenant/` по формату `tenant_<ID>` (например: `tenant_101/`).

#### 2. Настройте бота

Создайте файл `tg_bot.yaml`:
...
Создайте папку `scenarios/` и файлы сценариев в ней (можно использовать подпапки для организации).
...
📖 Подробнее о действиях, параметрах и плейсхолдерах: [SCENARIO_CONFIG_GUIDE.md](SCENARIO_CONFIG_GUIDE.md), [ACTION_GUIDE.md](ACTION_GUIDE.md)

### Синхронизация изменений

После внесения изменений в сценарии и push в [GitHub-репозиторий](https://github.com/Vensus137/Coreness-Tenant):

#### Автоматическая синхронизация

Система автоматически проверяет изменения в репозитории и синхронизирует обновлённые тенанты в фоновом режиме.

#### Принудительная синхронизация

Для немедленного обновления используйте мастер-бота:
1. Откройте **[Master Bot](https://t.me/coreness_master_bot)**
2. Отправьте команду `/tenant`
3. Введите ID вашего тенанта (если ранее не был введён)
4. Нажмите кнопку **"Синхронизировать"**

Система автоматически загрузит и обновит данные.
