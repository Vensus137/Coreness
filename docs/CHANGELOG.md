...
- **Система версионирования** — подготовка к релизу трех версий (Base, Pro, Max)
- **Универсальный менеджер обновлений** — поддержка всех трех версий (Base, Pro, Max) в едином интерфейсе
