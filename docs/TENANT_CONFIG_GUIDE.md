...
- **Публичные тенанты** (ID ≥ 100):
  - Синхронизируются с внешним репозиторием [Coreness-Tenant](https://github.com/Vensus137/Coreness-Tenant)
...
Публичные тенанты (ID ≥ 100) синхронизируются с внешним репозиторием [Coreness-Tenant](https://github.com/Vensus137/Coreness-Tenant) через GitHub.
...
- **`bot_name`** — имя бота (отображается в системе)
...
1. **Через конфигурацию** (`tg_bot.yaml`) — при синхронизации конфигурации токен из файла сохраняется в базу данных
