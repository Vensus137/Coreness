...
- **`bot_id`** (`integer`, обязательное, min: 1) — ID бота от которого пришло событие
...
- **`tenant_id`** (`integer`, обязательное, min: 1) — ID tenant'а для синхронизации сценариев
...
- **`tenant_id`** (`integer`, обязательное, min: 1) — ID тенанта для синхронизации
