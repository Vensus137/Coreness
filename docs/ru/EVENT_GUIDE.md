...
- [Типы событий](#типы-событий) — описание всех типов событий системы
- [Общие поля](#общие-поля) — поля, доступные во всех событиях
- [Поля scheduled сценариев](#поля-scheduled-сценариев) — дополнительные поля для scheduled сценариев
- [Поля сообщений](#поля-сообщений) — дополнительные поля для событий типа `message`
- [Поля callback](#поля-callback) — дополнительные поля для событий типа `callback`
- [События платежей](#события-платежей) — поля для событий платежей через Telegram
- [События участников](#события-участников) — поля для событий входа/выхода участников
- [Inline-клавиатура](#inline-клавиатура) — структура inline-клавиатуры в сообщениях
- [Поля вложений](#поля-вложений) — структура вложений в сообщениях
- [Примеры использования](#примеры-использования) — как использовать поля в сценариях
