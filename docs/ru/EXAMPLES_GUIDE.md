...
- [🚀 Быстрый старт](#-быстрый-старт)
  ...
  - [Создание первого сценария (системный тенант)](#создание-первого-сценария-системный-тенант)
  - [Применение изменений (системный тенант)](#применение-изменений-системный-тенант)
  - [Публичные тенанты (опционально)](#публичные-тенанты-опционально)
...
📖 Типы тенантов и синхронизация: [TENANT_CONFIG_GUIDE.md](TENANT_CONFIG_GUIDE.md).
