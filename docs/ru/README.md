---
title: Coreness — Платформа для AI-агентов и Telegram-ботов
description: Самостоятельно размещаемая мультитенантная платформа для создания AI-агентов и Telegram-ботов через декларативные YAML-конфигурации. Быстрый старт, руководства и справочники.
...
### 🔧 [Master Bot — Управление тенантами](MASTER_BOT_GUIDE.md)
...
2. **[Master Bot](MASTER_BOT_GUIDE.md)** — настройте управление тенантами (если разворачиваете платформу)
3. **[Руководство по сценариям](SCENARIO_CONFIG_GUIDE.md)** — изучите создание сценариев
4. **[Гайд по действиям](ACTION_GUIDE.md)** — изучите доступные действия
5. **[Гайд по событиям](EVENT_GUIDE.md)** — изучите работу с плейсхолдерами
6. **[Настройка тенантов](TENANT_CONFIG_GUIDE.md)** — настройте бота
7. **[Хранилище атрибутов](STORAGE_CONFIG_GUIDE.md)** — работа с данными
8. **[Модели AI](AI_MODELS_GUIDE.md)** — настройка AI (опционально)
9. **[Changelog](CHANGELOG.md)** — последние изменения (опционально)
