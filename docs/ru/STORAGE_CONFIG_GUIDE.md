---
title: Руководство по хранилищу атрибутов
description: Работа с хранилищем атрибутов (Storage) в Coreness. Tenant Storage, User Storage, типы значений и использование в сценариях.
keywords: storage coreness, key-value хранилище, tenant storage, user storage, настройки тенанта
---
...
| Характеристика | Tenant Storage | User Storage |
|----------------|----------------|--------------|
| Группировка | По `group_key` | Без групп |
| Источник данных | YAML файлы | Действия сценариев |
| Синхронизация | Автоматическая из конфигурации | Ручное управление |
| Область применения | Настройки тенанта | Данные пользователей |
