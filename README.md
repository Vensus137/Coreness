...
Полная документация доступна в папке **[`docs/`](docs/)** → **[Навигация по документации](docs/ru/README.md)**

### Быстрый старт
- 🚀 **[Практические примеры](docs/ru/EXAMPLES_GUIDE.md)** — от простого бота до AI-агента с RAG
- 📋 **[Руководство по сценариям](docs/ru/SCENARIO_CONFIG_GUIDE.md)** — создание логики ботов
- 🎯 **[Гайд по действиям](docs/ru/ACTION_GUIDE.md)** — справочник всех доступных действий

### Конфигурация
- ⚙️ **[Конфигурация тенантов](docs/ru/TENANT_CONFIG_GUIDE.md)** — настройка ботов
- 💾 **[Хранилище атрибутов](docs/ru/STORAGE_CONFIG_GUIDE.md)** — работа со Storage
- 🤖 **[Модели AI](docs/ru/AI_MODELS_GUIDE.md)** — интеграция с LLM

### Справочники
- 📡 **[События системы](docs/ru/EVENT_GUIDE.md)** — доступные поля в плейсхолдерах
- 🔄 **[Changelog](docs/ru/CHANGELOG.md)** — история изменений и обновлений

### Расширенная документация
- 🔧 **[Master Bot](docs/ru/advanced/MASTER_BOT_GUIDE.md)** — система управления тенантами (аналог @BotFather)
- 🏗️ **[Архитектура платформы](docs/ru/advanced/ARCHITECTURE.md)** — детальное описание архитектуры и паттернов
- 🚀 **[Развертывание и деплой](docs/ru/advanced/DEPLOYMENT.md)** — полное руководство по установке и обновлению
