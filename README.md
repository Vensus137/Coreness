...
Полная документация доступна в папке **[`docs/`](docs/)** → **[Навигация по документации](docs/README.md)**
...
- 🔄 **[Changelog](docs/CHANGELOG.md)** — история изменений и обновлений

### Расширенная документация
- 🔧 **[Master Bot](docs/advanced/MASTER_BOT_GUIDE.md)** — система управления тенантами (аналог @BotFather)
