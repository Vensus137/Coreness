...
class WebhookManager:
    ...
    def __init__(self, cache_manager, http_server, settings_manager, logger):
        self.cache_manager = cache_manager
        self.logger = logger
        self.http_server = http_server
        
        # Get settings from telegram_bot_manager
        bot_manager_settings = settings_manager.get_plugin_settings("telegram_bot_manager")
        self.cache_ttl = bot_manager_settings.get('cache_ttl', 315360000)  # Eternal cache
        self.webhook_endpoint = bot_manager_settings.get('webhook_endpoint', '/webhooks/telegram')
